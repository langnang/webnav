...
<footer class="main-footer sticky footer-type-1">
  <div class="footer-inner">
    <div class="zmki_footer_mar">
      ...
      Design BY <a href="https://github.com/WebStackPage/WebStackPage.github.io" target="_blank" rel="nofollow"><strong>WebStackPage</strong></a> Modify BY <a href="https://github.com/LightAPIs" target="_blank" rel="nofollow"><strong>Light</strong></a>.
    </div>
...
?><?php if ($this->options->zmki_wapsl=='1'): ?>@media screen and (max-width: 768px) {
  .col-sm-3 {
    width: 50%;
    float: left;
  }
