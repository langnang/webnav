<div class="tab-content">
  <div class="tab-pane fade @if ($_GET['step'] == 1) show active @endif">
    01...
    <a href="?step=02">next</a>
  </div>
  <div class="tab-pane fade @if ($_GET['step'] == 2) show active @endif">
    02...
    <a href="?step=03">next</a>
  </div>
  <div class="tab-pane fade @if ($_GET['step'] == 3) show active @endif">
    03...
    <a href="?step=04">next</a>
  </div>
  <div class="tab-pane fade @if ($_GET['step'] == 4) show active @endif">
    04...
    <a href="?step=05">next</a>
  </div>
  <div class="tab-pane fade @if ($_GET['step'] == 5) show active @endif">
    05...
  </div>
</div>
<div class="row">
